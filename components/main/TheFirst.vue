<template>
		...
		<div class="first-sub__container">
			...
			<ul class="first-sub__list first-sub-list">
				<li class="first-sub-list__element">
					<h4>{{ $t('main.firstSub.firstSubList.elementOne.title') }}</h4>
					<p>{{ $t('main.firstSub.firstSubList.elementThree.description') }}</p>
				</li>
				<li class="first-sub-list__element">
					<h4>{{ $t('main.firstSub.firstSubList.elementTwo.title') }}</h4>
					<p>{{ $t('main.firstSub.firstSubList.elementThree.description') }}</p>
				</li>
				<li class="first-sub-list__element">
					<h4>{{ $t('main.firstSub.firstSubList.elementThree.title') }}</h4>
					<p>{{ $t('main.firstSub.firstSubList.elementThree.description') }}</p>
				</li>
			</ul>
			<ul class="first-sub__listTwo first-sub-listTwo">
				<li class="first-sub-listTwo__element">
					<p>
						{{ $t('main.firstSub.firstSubListTwo.elementThree.description') }}
					</p>
				</li>
				<li class="first-sub-listTwo__element">
					<p>
	...
	<section class="first-mobile-slider">
		<div class="first-mobile-slider__container">
			<Swiper
