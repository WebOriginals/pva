...
const styleInput = {
  ...
  rounded: 'rounded-lg',
  placeholder: 'placeholder-sky-400 dark:placeholder-sky-700',
  icon: {
    base: 'flex-shrink-0 text-sky-400 dark:text-sky-700',
    size: {
      xxl: 'h-6 w-11',
    },
  },
...
<template>
  <UInput
      icon="icon-pva__search"
      trailing="trailing"
      :size="size"
      variant="none"
      :placeholder="$t('UiSearchServiceLabel')"
      :ui="styleInput"
  ></UInput>
</template>
